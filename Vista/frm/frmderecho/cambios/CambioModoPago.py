...
class CambioModoPago(QWidget):
    def __init__(self):
        super().__init__()
        self.layout = QGridLayout(self)
        self.lbl_mpago_cambio = QLabel("Modo Pago", self)
        self.cmbx_mpago_cambio = QComboBox(self)
        ...
        self.lbl_detalle_cambio = QLabel("Detalles", self)
        self.txt_detalle_cambio = QLineEdit(self)
    ...
    def setup_ui(self):
        self.cmbx_mpago_cambio.setMinimumSize(250, 0)
        self.txt_id_cambio.setEnabled(False)

        self.layout.addWidget(self.lbl_mpago_cambio, 1, 1)
        self.layout.addWidget(self.cmbx_mpago_cambio, 1, 2, 1, 2)
        ...
        self.layout.addWidget(self.lbl_detalle_cambio, 5, 1)
        self.layout.addWidget(self.txt_detalle_cambio, 5, 2, 1, 2)
        ...
        self.layout.addItem(self.v_spacer_2, 6, 2)
        self.layout.addItem(self.v_spacer_3, 8, 2)
